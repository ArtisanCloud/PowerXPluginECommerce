...
func RBACEntries(prefix string) map[string]authx.Permission {
	...
	return map[string]authx.Permission{
		...
		"GET:" + base + "/pricebooks/:pricebookId/versions":                     {Resource: res("pricing.pricebook"), Action: "read"},
		"POST:" + base + "/pricebooks/:pricebookId/versions":                    {Resource: res("pricing.pricebook"), Action: "manage"},
		"GET:" + base + "/pricebooks/:pricebookId/versions/:versionId/items":    {Resource: res("pricing.pricebook"), Action: "read"},

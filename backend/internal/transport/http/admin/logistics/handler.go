...
type Handler struct {
	...
	financeRiskSvc    *logisticssvc.FulfillmentFinanceRiskService
	opsAutomationSvc  *logisticssvc.OpsAutomationService
...
func NewHandler(
	...
	return &Handler{
		...
		caseSvc:           caseSvc,
		financeRiskSvc:    financeRiskSvc,
		opsAutomationSvc:  opsAutomationSvc,
		notifySvc:         notifySvc,
		slaSvc:            slaSvc,
		labelSvc:          labelSvc,

...
type ProductSKUInventory struct {
	...
	SKUId          string         `gorm:"column:sku_id;type:uuid;not null;index:idx_sku_wh_unique,priority:1" json:"sku_id"`
	WarehouseID    string         `gorm:"type:varchar(64);not null;index:idx_sku_wh_unique,priority:2" json:"warehouse_id"`

...
type ProductSKU struct {
	...
	TenantUUID     string         `gorm:"type:uuid;not null;index:idx_product_sku_tenant_code,priority:1;uniqueIndex:uk_product_sku_spec_signature,priority:1;comment:租户" json:"tenant_uuid"`
	SPUID          string         `gorm:"column:spu_id;type:uuid;not null;index;uniqueIndex:uk_product_sku_spec_signature,priority:2;comment:所属 SPU" json:"spu_id"`
	...
	SpecSignature  string         `gorm:"type:text;uniqueIndex:uk_product_sku_spec_signature,priority:3;comment:规格组合签名" json:"spec_signature,omitempty"`

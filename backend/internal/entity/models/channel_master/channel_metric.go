...
type ChannelMetric struct {
	...
	TenantUUID        string         `gorm:"type:uuid;not null;index:idx_channel_metric_tenant,priority:1;uniqueIndex:uniq_channel_metric_scope,priority:1" json:"tenant_uuid"`
	ChannelID         string         `gorm:"type:uuid;not null;index:idx_channel_metric_tenant,priority:2;uniqueIndex:uniq_channel_metric_scope,priority:2" json:"channel_id"`
	Window            string         `gorm:"type:varchar(8);not null;comment:d1/d7/d30;uniqueIndex:uniq_channel_metric_scope,priority:3" json:"window"`

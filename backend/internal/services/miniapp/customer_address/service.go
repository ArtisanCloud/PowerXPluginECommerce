...
func (s *Service) ListAddresses(ctx context.Context, tenantUUID, customerID string) ([]CustomerAddressDTO, error) {
	if !s.Ready() {
...
func (s *Service) CreateAddress(ctx context.Context, tenantUUID, customerID string, req AddressUpsertRequest) (*CustomerAddressDTO, error) {
	if !s.Ready() {
		return nil, ErrAddressServiceUnavailable
	}
	customerID = strings.TrimSpace(customerID)
...
func (s *Service) UpdateAddress(ctx context.Context, tenantUUID, customerID, id string, req AddressUpsertRequest) (*CustomerAddressDTO, error) {
	if !s.Ready() {
		return nil, ErrAddressServiceUnavailable
	}
	customerID = strings.TrimSpace(customerID)
...
func (s *Service) DeleteAddress(ctx context.Context, tenantUUID, customerID, id string) error {
	if !s.Ready() {
...
func (s *Service) SetDefault(ctx context.Context, tenantUUID, customerID, id string) (*CustomerAddressDTO, error) {
	if !s.Ready() {
		return nil, ErrAddressServiceUnavailable
	}
	customerID = strings.TrimSpace(customerID)

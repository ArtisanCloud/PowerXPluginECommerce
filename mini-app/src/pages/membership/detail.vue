  ...
  <view class="min-h-screen w-full bg-background-light font-display text-gray-900" style="padding-bottom: 96px;">
    ...
    >
      <view class="flex items-center justify-between">
        ...
        <text class="text-base font-extrabold">会籍详情</text>
    ...
    <view class="px-4 pt-4 space-y-4">
      <view class="rounded-2xl bg-white p-5 shadow-sm">
        <view class="flex items-center gap-4">
          ...
          <view class="px-3 py-1 rounded-full text-xs font-bold" style="background:#e7f6ed;color:#16a34a;">已生效</view>
        </view>
      </view>
      ...
      <view class="rounded-2xl bg-white p-5 shadow-sm">
        <view class="text-sm font-extrabold mb-3">会籍操作</view>
        <button class="w-full rounded-full bg-primary py-3 text-sm font-extrabold text-white" @tap="goUpgrade">
          升级/续费
        </button>
        <button class="mt-3 w-full rounded-full bg-white py-3 text-sm font-extrabold text-gray-900 shadow-sm" @tap="goBenefits">
          权益详情
        </button>
      </view>
    </view>

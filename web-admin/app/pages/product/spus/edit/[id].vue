<template>
  <div class="max-w-6xl mx-auto py-6 space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-semibold tracking-tight text-gray-900 dark:text-gray-100">编辑 SPU</h1>
    ...
    <template v-if="productForm">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="p-5 space-y-4">
              ...
              <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                <div
                  ...
                  :key="index"
                  class="group relative rounded-lg overflow-hidden border border-gray-200 dark:border-gray-800"
                >
          ...
          <!-- 自定义属性 -->
          <section class="rounded-xl border border-gray-200/60 dark:border-gray-800/60 bg白/70 dark:bg-gray-900/60 shadow-sm">
            ...
            <div class="p-5 space-y-3">
              <div
                v-for="(field, index) in productForm.customFields"
                :key="index"
                class="grid grid-cols-1 md:grid-cols-6 gap-3 items-center"
              >
                ...
                <div class="md:col-span-1 flex justify-end">
                  <UButton color="red" variant="soft" icon="i-heroicons-trash" @click="removeCustomField(index)">
                    删除
                  </UButton>
                </div>
              </div>
          ...
          <section class="rounded-xl border border-gray-200/60 dark:border-gray-800/60 bg-white/70 dark:bg-gray-900/60 shadow-sm">
            ...
            <div class="p-5 space-y-3">
              <div
                v-for="(lang, index) in productForm.languages"
                :key="index"
              ...
              >
                ...
                <div class="md:col-span-1 flex justify-end">
                  <UButton color="red" variant="soft" icon="i-heroicons-trash" @click="removeLanguage(index)">
                    删除
                  </UButton>
                </div>
              </div>
...
const productForm = ref({
  ...
  seoTitle: "Apple iPhone 15 Pro 最新款智能手机",
  seoDescription: "Apple iPhone 15 Pro 配备A17 Pro芯片，拥有钛金属设计和全新的操作按钮。",
  ...
  regulatoryRequirements: "3C认证",

  // 扩展属性
  languages: [
    { code: "zh", name: "iPhone 15 Pro" },
    { code: "en", name: "iPhone 15 Pro" }
  ],
  channels: {
    online: true,
    inStore: true,
  ...
  customFields: [
    { name: "产品线", value: "Pro系列" },
    { name: "发布年份", value: "2023" }
  ]
});
